...
public:
  ...
  static Glib::RefPtr<SourceBuffer> create(const Glib::RefPtr<Gtk::TextTagTable>& tag_table);
   ...
   * @newin{2,10}
   */
  Glib::RefPtr<SourceUndoManager> get_undo_manager();
   ...
   * @newin{2,10}
   */
  Glib::RefPtr<const SourceUndoManager> get_undo_manager() const;
...
/** The buffer undo manager.
   ...
   * the value of the property changes.
   */
  Glib::PropertyProxy< Glib::RefPtr<SourceUndoManager> > property_undo_manager() ;
#endif //#GLIBMM_PROPERTIES_ENABLED
...
/** The buffer undo manager.
   ...
   * the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< Glib::RefPtr<SourceUndoManager> > property_undo_manager() const;
#endif //#GLIBMM_PROPERTIES_ENABLED
