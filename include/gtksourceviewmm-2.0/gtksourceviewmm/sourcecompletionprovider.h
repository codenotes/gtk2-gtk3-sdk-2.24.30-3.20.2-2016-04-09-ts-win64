...
{ class SourceCompletionProvider_Class; } // namespace gtksourceview
namespace gtksourceview
{
...
namespace Glib
{
   ...
   *
   * @relates gtksourceview::SourceCompletionProvider
   */
  Glib::RefPtr<gtksourceview::SourceCompletionProvider> wrap(GtkSourceCompletionProvider* object, bool take_copy = false);
