...
public:
   ...
   * <tt>nullptr</tt> if given File is invalid. The returned string should be
   ...
   * This call does no blocking I/O.
   * 
   * @return String containing the File's path, or <tt>nullptr</tt>
   ...
   * to @a parent, or <tt>nullptr</tt> if @a descendant doesn't have @a parent as
